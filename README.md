...
3. [**reprojection.ipynb**](notebooks/03_reprojection.ipynb)
...
6. [**rasterization_and_vectorization.ipynb**](notebooks/06_rasterization_and_vectorization.ipynb)
- rasterizing vector geometries into rasters
- vectorizing raster regions into geometries
<br>

7. [**nodata_management.ipynb**](notebooks/07_nodata_management.ipynb)
